    ...
    try {
      ...
      if (isset($_POST['simpan'])) {
        ...
        if ($this->form_validation->run()) {
          ...
          redirect('admin/master/orangterlantar/index');
        } else {
  ...
  public function delete($id)
  {
    try {
      ...
      if ($method == 'POST') {
        ...
        if ($this->Terlantar->is_using('orang_terlantar_id', $id)) {
          $this->session->set_flashdata('error', 'Jenis Orang Terlantar ' . $orang_terlantar['orang_terlantar_nama'] . " masih digunakan, tidak bisa dihapus");
          redirect('admin/master/orangterlantar/index');
        }
        if ($orang_terlantar) {
