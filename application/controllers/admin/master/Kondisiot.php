    ...
    try {
      ...
      if (isset($_POST['simpan'])) {
        ...
        if ($this->form_validation->run()) {
          ...
          redirect('admin/master/kondisiot/index');
        } else {
  ...
  public function delete($id)
  {
    try {
      ...
      if ($method == 'POST') {
        ...
        if ($this->Terlantar->is_using('kondisi_ot_id', $id)) {
          $this->session->set_flashdata('error', 'Kondisi Orang Terlantar ' . $kondisi_ot['kondisi_ot_nama'] . " masih digunakan, tidak bisa dihapus");
          redirect('admin/master/kondisiot/index');
        }
        if ($kondisi_ot) {
