    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <div class="form-group">
          ...
          <input type="text" data-inputmask="'alias': 'currency'" class="form-control <?= (form_error('bansos_total') != null) ? 'is-invalid' : '' ?>" id="bansos_total" name="bansos_total" placeholder="Masukkan Total Bantuan Sosial" value="<?= ($this->input->post('bansos_total') ? $this->input->post('bansos_total') : ""); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <select name="sumber_dana_id" id="sumber_dana_id" class="form-control <?= (form_error('sumber_dana_id') != null) ? 'is-invalid' : '' ?>">
            ...
            <?php foreach ($_sumber_danas as $_sumber_dana) : ?>
              <option value="<?= $_sumber_dana['sumber_dana_id'] ?>" <?= ($this->input->post('sumber_dana_id') == $_sumber_dana['sumber_dana_id']) ? "selected" : "" ?>><?= $_sumber_dana['sumber_dana_nama'] ?></option>
            <?php endforeach; ?>
          </select>
          <div class="invalid-feedback">
