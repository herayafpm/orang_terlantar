...
<script>
    ...
    function exportexcel() {
        var url = '<?= base_url(str_replace("/$_status/", "/", str_replace("_", "", $_excel))) . "/" . $_id . "/" . $_status ?>';
        $('.optionData').attr('action', url)
        $('#date_hidden').val(date)
        $('#nama_hidden').val(nama)
        $('#nik_hidden').val(nik)
        $('#no_kk_hidden').val(no_kk)
        $('#desa_hidden').val(desa)
        $('#kecamatan_hidden').val(kecamatan)
        $('#kabupaten_hidden').val(kabupaten)
        $('#tempat_tinggal_id_hidden').val(tempat_tinggal_id)
        $('#kondisi_tempat_tinggal_id_hidden').val(kondisi_tempat_tinggal_id)
        $('#kategori_ot_id_hidden').val(kategori_ot_id)
        $('#fasilitas_kesehatan_id_hidden').val(fasilitas_kesehatan_id)
        $('#kondisi_ot_id_hidden').val(kondisi_ot_id)
        $('#kebutuhan_diperlukan_id_hidden').val(kebutuhan_diperlukan_id)
        $('.optionData').submit();
    }

    function printData() {
        var url = '<?= base_url(str_replace("/$_status/", "/", str_replace("_", "", $_print))) . "/" . $_id . "/" . $_status ?>';
        $('.optionData').attr('action', url)
        $('#date_hidden').val(date)
        $('#nama_hidden').val(nama)
        $('#nik_hidden').val(nik)
    ...
    $(document).ready(function() {
        tabel = $('#datatable').DataTable({
            ...
            "columns": [{
                ...
                {
                    "data": "admin_tolak_nama",
                },
                {
                    "render": function(data, type, row) {
                        return toLocaleDate(row.tolak_at)
                    }
                },
                {
                    "data": "created_at",
