...
$(document).ready(function() {
    var tabel = $('#datatable').DataTable({
        ...
        "columns": [
            { "data": "admin_id" },
            { "data": "admin_nama" },  // Tampilkan nama
            { "render": function ( data, type, row ) { // Tampilkan kolom aksi
                    var html = '<form method="POST" class="d-inline deleteData"><button type="button" class="btn btn-link" onClick="deleteData('+row.admin_id+')">DELETE</button></form>'
                    return html
                }
            },
        ],
