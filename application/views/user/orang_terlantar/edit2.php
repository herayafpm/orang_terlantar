    ...
    <div class="row">
      <div class="col-lg-4">
        ...
        <div class="form-group form-check">
          <input type="checkbox" name="have_identitas" class="form-check-input <?= (form_error('have_identitas') != null) ? 'is-invalid' : '' ?>" id="have_identitas" value="1" <?= ($this->input->post('have_identitas')) == 1 ? "checked" : ($_terlantar['identitas_kependudukan'] == 1) ? "checked" : ""; ?>>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('nama') != null) ? 'is-invalid' : '' ?>" id="nama" name="nama" placeholder="Masukkan Nama Orang Terlantar" value="<?= ($this->input->post('nama')) ? $this->input->post('nama') : ($_terlantar['terlantar_nama']) ? $_terlantar['terlantar_nama'] : ""; ?>">
          <div class="invalid-feedback">
            <?= form_error('nama'); ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="text" data-inputmask-alias="9" data-inputmask-repeat="16" class="form-control <?= (form_error('nik') != null) ? 'is-invalid' : '' ?>" id="nik" name="nik" placeholder="Masukkan NIK Orang Terlantar" value="<?= ($this->input->post('nik') ? $this->input->post('nik') : ($_terlantar['terlantar_nik']) ? $_terlantar['terlantar_nik'] : ""); ?>">
          <div class="invalid-feedback">
            <?= form_error('nik'); ?>
          </div>
        </div>
        <div class="form-group">
          <label for="no_dtks">NO DTKS / BDT Orang Terlantar</label>
          <input type="text" class="form-control <?= (form_error('no_dtks') != null) ? 'is-invalid' : '' ?>" id="no_dtks" name="no_dtks" placeholder="Masukkan NO DTKS / BDT Orang Terlantar" value="<?= ($this->input->post('no_dtks') ? $this->input->post('no_dtks') : ($_terlantar['terlantar_no_dtks']) ? $_terlantar['terlantar_no_dtks'] : ""); ?>">
          <div class="invalid-feedback">
            <?= form_error('no_dtks'); ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="text" data-inputmask-alias="9" data-inputmask-repeat="16" class="form-control <?= (form_error('no_kk') != null) ? 'is-invalid' : '' ?>" id="no_kk" name="no_kk" placeholder="Masukkan NO KK Orang Terlantar" value="<?= ($this->input->post('no_kk') ? $this->input->post('no_kk') : ($_terlantar['terlantar_no_kk']) ? $_terlantar['terlantar_no_kk'] : ""); ?>">
          <div class="invalid-feedback">
            <?= form_error('no_kk'); ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('tempat_lahir') != null) ? 'is-invalid' : '' ?>" id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan Tempat Lahir Orang Terlantar" value="<?= ($this->input->post('tempat_lahir') ? $this->input->post('tempat_lahir') : ($_terlantar['terlantar_tempat_lahir']) ? $_terlantar['terlantar_tempat_lahir'] : ""); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <input type="text" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" class="form-control <?= (form_error('tanggal_lahir') != null) ? 'is-invalid' : '' ?>" id="tanggal_lahir" name="tanggal_lahir" placeholder="Masukkan Tanggal Lahir Orang Terlantar" value="<?= ($this->input->post('tanggal_lahir') ? $this->input->post('tanggal_lahir') : ($_terlantar['terlantar_tanggal_lahir']) ? date('m-d-Y', strtotime($_terlantar['terlantar_tanggal_lahir'])) : ""); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('alamat') != null) ? 'is-invalid' : '' ?>" id="alamat" name="alamat" placeholder="Masukkan Alamat Jalan / Perumahan Orang Terlantar" value="<?= ($this->input->post('alamat')) ? $this->input->post('alamat') : ($_terlantar['terlantar_alamat']) ? $_terlantar['terlantar_alamat'] : ""; ?>">
          <div class="invalid-feedback">
            <?= form_error('alamat'); ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('rt') != null) ? 'is-invalid' : '' ?>" id="rt" name="rt" placeholder="Masukkan RT" value="<?= ($this->input->post('rt')) ? $this->input->post('rt') : ($_terlantar['terlantar_rt']) ? $_terlantar['terlantar_rt'] : ""; ?>">
          <div class="invalid-feedback">
            <?= form_error('rt'); ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('rw') != null) ? 'is-invalid' : '' ?>" id="rw" name="rw" placeholder="Masukkan RW" value="<?= ($this->input->post('rw')) ? $this->input->post('rw') : ($_terlantar['terlantar_rw']) ? $_terlantar['terlantar_rw'] : "" ?>">
          <div class="invalid-feedback">
            <?= form_error('rw'); ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('desa') != null) ? 'is-invalid' : '' ?>" id="desa" name="desa" placeholder="Masukkan Desa" value="<?= ($this->input->post('desa')) ? $this->input->post('desa') : ($_terlantar['terlantar_desa']) ? $_terlantar['terlantar_desa'] : "" ?>">
          <div class="invalid-feedback">
            <?= form_error('desa'); ?>
          </div>
        </div>
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('kecamatan') != null) ? 'is-invalid' : '' ?>" id="kecamatan" name="kecamatan" placeholder="Masukkan Kecamatan" value="<?= ($this->input->post('kecamatan')) ? $this->input->post('kecamatan') : ($_terlantar['terlantar_kecamatan']) ? $_terlantar['terlantar_kecamatan'] : ""; ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control <?= (form_error('kabupaten') != null) ? 'is-invalid' : '' ?>" id="kabupaten" name="kabupaten" placeholder="Masukkan Kabupaten" value="<?= ($this->input->post('kabupaten')) ? $this->input->post('kabupaten') : ($_terlantar['terlantar_kabupaten']) ? $_terlantar['terlantar_kabupaten'] : ""; ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control <?= (form_error('no_telp') != null) ? 'is-invalid' : '' ?>" id="no_telp" name="no_telp" placeholder="Masukkan No Telepon (WA)" value="<?= ($this->input->post('no_telp')) ? $this->input->post('no_telp') : ($_terlantar['terlantar_telp']) ? $_terlantar['terlantar_telp'] : ""; ?>">
          <div class="invalid-feedback">
            <?= form_error('no_telp'); ?>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="kebutuhan_diperlukan" id="kebutuhan_diperlukan" class="form-control <?= (form_error('kebutuhan_diperlukan') != null) ? 'is-invalid' : '' ?>">
            <option value="" <?= ($this->input->post('kebutuhan_diperlukan') == "") ? "selected" : "" ?>>-- Pilih Kebutuhan Yang Diperlukan --</option>
        ...
        <div class="form-group kebutuhan_diperlukan d-none">
          <label for="kebutuhan_diperlukan_lainnya">Kebutuhan Diperlukan Lainnya</label>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control <?= (form_error('alasan_terlantar') != null) ? 'is-invalid' : '' ?>" id="alasan_terlantar" name="alasan_terlantar" rows="3" placeholder="Isi alasan terlantar"><?= ($this->input->post('alasan_terlantar')) ? $this->input->post('alasan_terlantar') : $_terlantar['alasan_terlantar']; ?></textarea>
          <div class="invalid-feedback">
        ...
        <div class="form-group outsider d-none">
          ...
          <input type="text" class="form-control <?= (form_error('tujuan_alamat') != null) ? 'is-invalid' : '' ?>" id="tujuan_alamat" name="tujuan_alamat" placeholder="Masukkan Alamat Tujuan Luar Daerah" value="<?= ($this->input->post('tujuan_alamat')) ? $this->input->post('tujuan_alamat') : $_terlantar['tujuan_alamat'] ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group outsider d-none">
          ...
          <input type="text" class="form-control <?= (form_error('tujuan_rt') != null) ? 'is-invalid' : '' ?>" id="tujuan_rt" name="tujuan_rt" placeholder="Masukkan RT Tujuan Luar Daerah" value="<?= ($this->input->post('tujuan_rt') ? $this->input->post('tujuan_rt') : $_terlantar['tujuan_rt']); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group outsider d-none">
          ...
          <input type="text" class="form-control <?= (form_error('tujuan_rw') != null) ? 'is-invalid' : '' ?>" id="tujuan_rw" name="tujuan_rw" placeholder="Masukkan RW Tujuan Luar Daerah" value="<?= ($this->input->post('tujuan_rw') ? $this->input->post('tujuan_rw') : $_terlantar['tujuan_rw']); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group outsider d-none">
          ...
          <input type="text" class="form-control <?= (form_error('tujuan_desa') != null) ? 'is-invalid' : '' ?>" id="tujuan_desa" name="tujuan_desa" placeholder="Masukkan Desa Tujuan Luar Daerah" value="<?= ($this->input->post('tujuan_desa') ? $this->input->post('tujuan_desa') : $_terlantar['tujuan_desa']); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group outsider d-none">
          ...
          <input type="text" class="form-control <?= (form_error('tujuan_kecamatan') != null) ? 'is-invalid' : '' ?>" id="tujuan_kecamatan" name="tujuan_kecamatan" placeholder="Masukkan Kecamatan Tujuan Luar Daerah" value="<?= ($this->input->post('tujuan_kecamatan') ? $this->input->post('tujuan_kecamatan') : $_terlantar['tujuan_kecamatan']); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group outsider d-none">
          ...
          <input type="text" class="form-control <?= (form_error('tujuan_kabupaten') != null) ? 'is-invalid' : '' ?>" id="tujuan_kabupaten" name="tujuan_kabupaten" placeholder="Masukkan Kabupaten Tujuan Luar Daerah" value="<?= ($this->input->post('tujuan_kabupaten') ? $this->input->post('tujuan_kabupaten') : $_terlantar['tujuan_kabupaten']); ?>">
          <div class="invalid-feedback">
        ...
        <div class="form-group outsider d-none">
          ...
          <input type="text" class="form-control <?= (form_error('tujuan_provinsi') != null) ? 'is-invalid' : '' ?>" id="tujuan_provinsi" name="tujuan_provinsi" placeholder="Masukkan Provinsi Tujuan Luar Daerah" value="<?= ($this->input->post('tujuan_provinsi') ? $this->input->post('tujuan_provinsi') : $_terlantar['tujuan_provinsi']); ?>">
          <div class="invalid-feedback">
