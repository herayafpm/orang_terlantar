...
<script>
  ...
  function editData(id) {
    window.location = "<?= base_url('user/orangterlantar/edit/') ?>" + id
  }
      ...
      "columns": [{
        ...
        }, // Tampilkan nama
        {
          "render": function(data, type, row) { // Tampilkan kolom aksi
            ...
            if (row.proses_id != null) {
              html = "Sedang diproses"
            }
            if (row.verif_id != null) {
              html = "Sudah Diverifikasi";
            }
            if (row.tolak_id != null) {
              html = "Ditolak"
            }
        ...
        },
        {
          "render": function(data, type, row, meta) { // Tampilkan kolom aksi
            var html = '<button type="button" class="btn btn-link" onClick="showData(' + meta.row + ')">DETAIL</button>'
            if (row.proses_id == null && row.verif_id == null && row.tolak_id == null) {
